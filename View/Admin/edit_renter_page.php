    ...
    <tr>
        ...
        <td align="center" valign="top">
            <table border="0" width="100%" cellpadding="15" cellspacing="0" align="center" >
                ...
                <tr>
                    <td align="center" valign="top">
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" onsubmit="return editUser(<?php echo $renterId ?>)">
                                            ...
                                            <tr>
                                                ...
                                                <td width="70%">
                                                    <button type="submit" name="submit" value="submit">
                                                        <font size="5" face="arial">Update Information</font>
                                                    </button>
                                                </td>
                                            </tr>
                                            <tr>
