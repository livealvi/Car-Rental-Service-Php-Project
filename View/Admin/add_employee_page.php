...
include '../../Controller/AdminController/add_employee_handler.php';
                                            ...
                                            <tr>
                                                ...
                                                <td width="70%">
                                                    <button type="submit" name="submit" value="submit">
                                                        <font size="5" face="arial">Add Employee</font>
                                                    </button>
                                                </td>
                                            </tr>
                                            <?php include '../../Controller/AdminController/add_employee_processor.php';?>
                                        </table>
                                    </td>
                                </tr>
                            </table>
