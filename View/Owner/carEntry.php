...
<html lang="en">
    ...
    <body>
        ...
        <h1 class="title">Car Entry</h1>
        <form class="cartop" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
         ...
         <br>
            ...
            <label for="serial">Car Sereal No :</label> <input type="text" name="serial"><br>
