<?php
/*This file will hold all the data queries related to EMPLOYEE_DOC table
of the database. For EMPLOYEE_DOC related functionality, add this file
...
require_once './Classes/Employee_doc.php';
