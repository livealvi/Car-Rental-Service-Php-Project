<?php
/*This file will hold all the data queries related to USER_DOC table
of the database. For USER_DOC related functionality, add this file
...
require_once 'Classes/User_doc.php';
